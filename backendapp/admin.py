...
from .models import Role,Staff,Specialization,Doctor,Membership,Patient,Appointment,MedicineCategory,Medicine, MedicinePrescription,Consultation,MedicineStock,LabTestCategory,LabTest,LabTestPrescription,ConsultationBill
...
# admin.site.register(ConsultationBilling)