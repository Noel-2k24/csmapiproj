...
class Appointment(models.Model):
    ...
    def __str__(self):
      return f"{self.AppointmentDate.strftime('%Y-%m-%d %H:%M')} - {self.PatientId.PatientName} with Dr. {self.DoctorId.StaffId.FullName}"
...
class LabTestPrescription(models.Model):
    ...
    # models.py
#---------------------------------------------------------------------------------------------------------------------------
# class ConsultationBilling(models.Model):
...
#         self.TotalAmount = self.BaseAmount + self.Tax - self.Discount
#         super().save(*args, **kwargs)

#     def __str__(self):
#         return f"Billing for Appointment {self.AppointmentId_id}"
#--------------------------------------------------------------------------------------------
from django.db import models
from .models import Appointment  # Assuming Appointment model is in same app
...
class ConsultationBill(models.Model):
    ...
    def __str__(self):
        return f"Bill for Appointment {self.AppointmentId_id}"